...
// Gradient palette "autumnasrai_gp", originally from
// http://soliton.vm.bytemark.co.uk/pub/cpt-city/rc/tn/autumnasrai.png.index.html
// converted for FastLED with gammas (2.6, 2.2, 2.5)
...
// Gradient palette "butterflyfairy_gp", originally from
// http://soliton.vm.bytemark.co.uk/pub/cpt-city/rc/tn/butterflyfairy.png.index.html
// converted for FastLED with gammas (2.6, 2.2, 2.5)
// Size: 20 bytes of program space.
...
// Gradient palette "desertjewel_gp", originally from
// http://soliton.vm.bytemark.co.uk/pub/cpt-city/rc/tn/desertjewel.png.index.html
// converted for FastLED with gammas (2.6, 2.2, 2.5)
// Size: 24 bytes of program space.

DEFINE_GRADIENT_PALETTE( desertjewel_gp ) {
    0,  53, 71, 35,
   45,  69, 74, 13,
   94,  61, 40,  2,
  160, 110, 24, 14,
...
DEFINE_GRADIENT_PALETTE( flesher_gp ) {
    0, 133, 91, 73,
  255, 110, 56, 27};
...
DEFINE_GRADIENT_PALETTE( impatientfairy_gp ) {
    0,  36,  5,  1,
   51,  74, 18,  2,
   89,  65, 22,  1,
  114, 103, 23, 10,
...
// Gradient palette "jeweleddragon_gp", originally from
// http://soliton.vm.bytemark.co.uk/pub/cpt-city/rc/tn/jeweleddragon.png.index.html
// converted for FastLED with gammas (2.6, 2.2, 2.5)
// Size: 52 bytes of program space.

DEFINE_GRADIENT_PALETTE( jeweleddragon_gp ) {
    0,   2,  1,  2,
   17,  11,  7, 13,
   35,  43, 20, 40,
   58,  91, 63, 95,
...
// Gradient palette "pinkchampagne_gp", originally from
// http://soliton.vm.bytemark.co.uk/pub/cpt-city/rc/tn/pinkchampagne.png.index.html
// converted for FastLED with gammas (2.6, 2.2, 2.5)
// Size: 12 bytes of program space.
...
// Gradient palette "pinkfairyrose_gp", originally from
// http://soliton.vm.bytemark.co.uk/pub/cpt-city/rc/tn/pinkfairyrose.png.index.html
// converted for FastLED with gammas (2.6, 2.2, 2.5)
// Size: 32 bytes of program space.
...
// Gradient palette "wildwinds_gp", originally from
// http://soliton.vm.bytemark.co.uk/pub/cpt-city/rc/tn/wildwinds.png.index.html
// converted for FastLED with gammas (2.6, 2.2, 2.5)
// Size: 20 bytes of program space.

DEFINE_GRADIENT_PALETTE( wildwinds_gp ) {
    0,  17,  6,  4,
   63,  51, 19, 13,
  127, 177,138,120,
  191,  30, 63,102,
...
const CRGBPalette16 defPalettes[] = {
    angelrepose_gp,
